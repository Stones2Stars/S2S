...
//
//	CvJsonComplexTraitInfo -- the COMPLEX/Thunderbrd trait set (StoneBase ComplexTraitInfo). Stored in its OWN repo
...
// The phantom repo TAG for the complex trait set (both sets store CvJsonTraitInfo subclasses keyed by the SAME engine id).
struct CvComplexTraitTag {};

class CvJsonComplexTraitInfo : public CvJsonTraitInfo {};
