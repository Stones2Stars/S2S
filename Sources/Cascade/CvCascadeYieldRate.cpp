...
// combine + clamp mirror StoneBase YieldRate.cs (the verified-final order).
// RAW COMPUTE -- no memo here: CascadeRates (the flipped-getter service) owns the ONE event-invalidated rate
// memo (2026-07-02; the old turn-scoped memo here would serve stale under it).
