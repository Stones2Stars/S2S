...
enum CvCascPredKind
{
	...
	CASC_PRED_IS_WATER, CASC_PRED_IS_LAND, CASC_PRED_IS_FLATLANDS, CASC_PRED_IS_AIR,
	...
	// predicate rather than left as an arithmetic branch inside one formula (docs/specs/json.md §3.5 Predicates (conditions are predicates, never bespoke members)).
	CASC_PRED_IS_REBEL,
