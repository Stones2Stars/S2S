...
public:
	...
	const CvJsonTraitInfo* getTraitInfo(int i) const;
	const CvJsonUnitInfo* getUnitInfo(int i) const;
	...
	const CvJsonPromotionLineInfo* getPromotionLineInfo(int i) const;
	const CvInfoBase* getDomainInfo(int i) const;
	const CvJsonBuildingInfo* getBuildingInfo(int i) const;
	const CvJsonCivicOptionInfo* getCivicOptionInfo(int i) const;
	const CvJsonCivicInfo* getCivicInfo(int i) const;
	const CvDiplomacyInfo* getDiplomacyInfo(int i) const;
	const CvJsonProjectInfo* getProjectInfo(int i) const;
	const CvVoteInfo* getVoteInfo(int i) const;
	const CvJsonProcessInfo* getProcessInfo(int i) const;
	const CvJsonSpecialistInfo* getSpecialistInfo(int i) const;
	const CvJsonReligionInfo* getReligionInfo(int i) const;
	const CvJsonHeritageInfo* getHeritageInfo(int i) const;
	const CvJsonCorporationInfo* getCorporationInfo(int i) const;
	const CvControlInfo* getControlInfo(int i) const;
	const CvJsonTechInfo* getTechInfo(int i) const;
	const CvSpecialBuildingInfo* getSpecialBuildingInfo(int i) const;
	const CvJsonPromotionInfo* getPromotionInfo(int i) const;
	const CvEmphasizeInfo * getEmphasizeInfo(int i) const;
	const CvUpkeepInfo * getUpkeepInfo(int i) const;
	const CvJsonCultureLevelInfo * getCultureLevelInfo(int i) const;
	...
	const CvJsonPropertyInfo* getPropertyInfo(int i) const;
