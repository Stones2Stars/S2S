...
#define DO_FOR_EACH_INT_GLOBAL_DEFINE(DO) \
	...
	DO(int, CITY_VISIBILITY_RANGE) \
	DO(int, CITY_BASE_ELEVATION) \
	...
	DO(int, AI_CONTRACT_MAX_TRAVEL_TURNS) \
	...
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_PREHISTORIC_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_PREHISTORIC_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_ANCIENT_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_ANCIENT_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_CLASSIC_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_CLASSIC_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_MEDIEVAL_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_MEDIEVAL_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_RENAISSANCE_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_RENAISSANCE_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_INDUSTRIAL_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_INDUSTRIAL_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_ATOMIC_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_ATOMIC_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_INFORMATION_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_INFORMATION_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_NANOTECH_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_NANOTECH_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_TRANSHUMAN_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_TRANSHUMAN_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_GALACTIC_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_GALACTIC_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_COSMIC_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_COSMIC_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_TRANSCENDENT_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_TRANSCENDENT_END) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_FUTURE_START) \
	DO(int, HISTORICAL_ACCURATE_ERA_RANGE_FUTURE_END) \
	DO_FOR_EACH_EXPOSED_INT_GLOBAL_DEFINE(DO)
