...
void CvPythonPlayerLoader::CyPlayerPythonInterface1(boost::python::class_<CyPlayer>& inst)
{
	...
	inst
		...
		.def("getGreatPeopleThresholdNonMilitary", &CyPlayer::getGreatPeopleThresholdNonMilitary)
		.def("getColorPrimary", &CyPlayer::getColorPrimary)
...
void CvPythonPlayerLoader::CyPlayerPythonInterface3(boost::python::class_<CyPlayer>& inst)
{
	...
	inst
		...
		.def("getCityIds", &CyPlayer::getCityIds, "list ()")

		// The EMPIRE-scope group reads -- the empire half of the game-object read role. Their city twins are the
		// identically-named reads on CyCity; scope is the RECEIVER, so neither carries a selector.
		.def("getYields", &CyPlayer::getYields, "list ()")
		.def("getCommerces", &CyPlayer::getCommerces, "list ()")
		.def("getWellbeing", &CyPlayer::getWellbeing, "list ()")
		.def("getDefenseKinds", &CyPlayer::getDefenseKinds, "list ()")
		.def("getMaintenanceKinds", &CyPlayer::getMaintenanceKinds, "list ()")
		.def("getBuildRateKinds", &CyPlayer::getBuildRateKinds, "list ()")
		.def("getCombatKinds", &CyPlayer::getCombatKinds, "list ()")
		.def("getExperienceKinds", &CyPlayer::getExperienceKinds, "list ()")
		.def("getRevolutionKinds", &CyPlayer::getRevolutionKinds, "list ()")
		.def("getTradeRouteKinds", &CyPlayer::getTradeRouteKinds, "list ()")
		.def("getScalars", &CyPlayer::getScalars, "list ()")
		.def("getUpkeepKinds", &CyPlayer::getUpkeepKinds, "list ()")
		.def("getCostKinds", &CyPlayer::getCostKinds, "list ()")
		.def("getStateReligionKinds", &CyPlayer::getStateReligionKinds, "list ()")
		.def("getDiplomacyKinds", &CyPlayer::getDiplomacyKinds, "list ()")
		.def("getDurationKinds", &CyPlayer::getDurationKinds, "list ()")
		.def("getAirKinds", &CyPlayer::getAirKinds, "list ()")
		.def("getCaptureKinds", &CyPlayer::getCaptureKinds, "list ()")
		.def("getCargoKinds", &CyPlayer::getCargoKinds, "list ()")
		...
		.def("getEmpireBuildings", &CyPlayer::getEmpireBuildings, "list getEmpireBuildings() - the empire-level buildings this player holds")
		.def("isEmpireBuildingActive", &CyPlayer::isEmpireBuildingActive, "bool isEmpireBuildingActive(int iBuilding)")
	;
}
