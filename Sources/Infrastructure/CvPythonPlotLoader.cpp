...
void CvPythonPlotLoader::CyPlotPythonInterface1(boost::python::class_<CyPlot>& inst)
{
	...
	inst
		...
		.def("calculateBestNatureYield", &CyPlot::calculateBestNatureYield, "int (int (YieldTypes) eYield, int (PlayerTypes) eObserver)")
		.def("calculateTotalBestNatureYield", &CyPlot::calculateTotalBestNatureYield, "int (int (PlayerTypes) eObserver)")
