...
{
	// #430 FLIP-WITH-NET (2026-07-02): the CASCADE verdict is authoritative; the legacy counter is DELETED
	// (net ran clean: 5.85M calls / 0 diverging with the cascade authoritative).
