...
//
//	CvPromotionInfo -- the per-type cascade info for PROMOTIONS. Composes the section units a promotion authors
...
public:
	...
	// CvPromotionLineInfo). The engine calls the setters post-load; the getters then read the computed vectors.
