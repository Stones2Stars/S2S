...
// CvJsonTechInfo.cpp's canTradeOnTerrains loop; kept local here since only this poco composes all three).
...
void CvJsonBonusInfo::setProvidedByImprovementTypes(const ImprovementTypes eType)
{
...
int CvJsonBonusInfo::getRandAppearance() const
{
