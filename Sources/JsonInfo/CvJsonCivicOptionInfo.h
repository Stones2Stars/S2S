...
//
//	CvJsonCivicOptionInfo -- the JSON poco for CIVIC OPTIONS (the civic category/slot axis: Government, Economy, …).
//	A civic option is a PURE STRUCTURAL AXIS: it carries no modifier families, no enables, no prereqs -- only its type
//	+ description (served by the CvJsonInfo base). The civic->option categorization lives on the CIVIC
...
class CvJsonCivicOptionInfo : public CvJsonInfo
{
public:
	CvJsonCivicOptionInfo() {}
