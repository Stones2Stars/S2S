...
public:
	...
	// RUNTIME (set post-load, NOT JSON; mirrors CvJsonCorporationInfo/CvJsonBuildInfo's runtime mission type)
...
private:
	...
	// unbuilt -- a cross-type deferral (CvJsonCorporationInfo/CvJsonHeritageInfo identical); returns a real empty object.
