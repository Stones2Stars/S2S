...
//
//	⏳ Slice-1 scope: the DOMAIN events the spine emits today -- building-built (SEVT_BUILDING_COUNT, delta>0)
...
//	Register the grants consumer + its [GRANTS] spine domain (idempotent). Called from spineRegisterConsumers.
