...
- **OOS / lockstep determinism** — integer math only; synced Soren RNG. `readJson` converts readable→`int×100` ONCE at load
  (deterministic; #432 owns de-scaling). No runtime float introduced. Canonical: [DEC-fixedpoint-x100](../decisions.md#dec-fixedpoint-x100).
