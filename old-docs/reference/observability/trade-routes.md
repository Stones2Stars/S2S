...
All hooks follow the three canonical observability hook shapes — see [DEC-obs-hook-shapes](../../decisions.md#dec-obs-hook-shapes). They are ordered by cascade-criticality: the bonus-connection oracle
